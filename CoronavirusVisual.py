...
def write_county_map():
    ...
    fig.write_json('./covid-19-visualization/src/Figures/counties.json')
    print('figure json data written')
    fig.write_html('./covid-19-visualization/src/Figures/counties.html')
...
def write_states_map():
    ...
    fig.write_json('./covid-19-visualization/src/Figures/states.json')
    fig.write_html('./covid-19-visualization/src/Figures/states.html')
...
def write_global_map():
    ...
    print('figure created')
    fig.write_json('./covid-19-visualization/src/Figures/countries.json')
    fig.write_html('./covid-19-visualization/src/Figures/countries.html')
